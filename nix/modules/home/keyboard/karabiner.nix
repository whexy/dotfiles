...
# This mirrors the kanata setup on NixOS (nix/modules/hosts/desktop/nixos.nix).
#
...
in
{
  config = lib.mkIf cfg.karabiner.enable (
    let
      keyboards = osConfig.dotfiles.hardware.keyboards or [ ];
    in
    {
