...
#
# One of the two renderers for the Linux bar, selected by
# dotfiles.panel.linuxBar. Feature modules (wm, ai-quota, renpho) merge
# their settings in with mkOrder, so this file stays feature-agnostic.
args@{
  config,
  lib,
  pkgs,
